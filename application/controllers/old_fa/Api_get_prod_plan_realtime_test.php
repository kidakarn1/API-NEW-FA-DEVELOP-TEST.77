...
class Api_get_prod_plan_realtime_test extends CI_Controller
{
	// var $ins;

	public function manage_prod_plan ()
	{
		// $ins = new Api_exp_get_cal_mst;

		$pd_time = $this->get_plan_date();
		// echo $pd_time;
		$pd_time = str_replace( "/" , "-" , $pd_time );
		$pd_time = $pd_time." 00:00:00";
		// $pd_time = "2022-05-14 00:00:00";
		// var_dump($pd_time); exit;
		...
		// $chk_lot_time = "2022-05-12 00:01:00";
	...
	public function ins_prod_plan ( $id_plan , $line_cd , $wi_no , $plan_date , $type , $seq_plan )  //INSERT NEW PRODUCTION PLAN
	{
		...
		$sqlIns = " INSERT INTO CONTROL_PROD_PLAN_TEST ( ID_PLAN , LINE_CD , WI , PROD_FLG , ORDER_FLG , STATUS_FLG , PLAN_DATE , CREATE_DATE , CREATE_BY , UPDATE_DATE , UPDATE_BY ) VALUES ( '$id_plan' , '$line_cd' , '$wi_no' , '$type' , '$seq_plan' , '0' , '$plan_date' , GETDATE() , 'SYSTEM' , GETDATE() , 'SYSTEM' );";
